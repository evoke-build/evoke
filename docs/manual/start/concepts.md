...
or no?* It answers with calibrated probabilities. Everything it knows about a reflex comes from the reflex's own
description, sent in the request. So the wording **is** the tuning, and one line —
